...
-- ----------------------------
INSERT INTO `sms_seckill_session` VALUES (1, '8:00', '2022-03-28 00:00:00', '2022-03-28 02:00:00', 1, '2022-03-27 06:07:14');
INSERT INTO `sms_seckill_session` VALUES (2, '10:00', '2022-03-29 02:00:00', '2022-03-29 04:00:00', 1, '2022-03-27 06:07:50');
INSERT INTO `sms_seckill_session` VALUES (3, '17:00', '2022-03-28 00:00:00', '2022-03-28 15:00:00', 1, '2022-03-28 06:03:56');
...
CREATE TABLE `sms_seckill_sku_relation`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 5 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '秒杀活动商品关联' ROW_FORMAT = Dynamic;
...
INSERT INTO `sms_seckill_sku_relation` VALUES (3, NULL, 1, 2, 999, 10, 1, 0);
INSERT INTO `sms_seckill_sku_relation` VALUES (4, NULL, 3, 1, 888, 6, 1, 0);
...
INSERT INTO `sms_spu_bounds` VALUES (3, 5, 1.0000, 1.0000, NULL);
